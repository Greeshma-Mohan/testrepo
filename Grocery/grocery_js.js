...
function calculate_grocery(){
    first_grocery_amount = parseFloat(document.getElementById('grocery_amount_1').value);
    second_grocery_amount = parseFloat(document.getElementById('grocery_amount_2').value);
    third_grocery_amount = parseFloat(document.getElementById('grocery_amount_3').value);
